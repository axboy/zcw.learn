...
public class MySlideView extends LinearLayout {
    ...
    private void initView() {
        ...
        View.inflate(mContext, R.layout.my_slide_view_merge, this);
        mViewContent = (LinearLayout) findViewById(R.id.my_slide_view_content);
    ...
    public void setButtonText(CharSequence text) {
        ((TextView)findViewById(R.id.my_slide_view_delete)).setText(text);
    }
    ...
    public void onRequireTouchEvent(MotionEvent event) {
       ...
       Log.w(TAG, "x=" + x + "  y=" + y + "  scrollX=" + scrollX);
