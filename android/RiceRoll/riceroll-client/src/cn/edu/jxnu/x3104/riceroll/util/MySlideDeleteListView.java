...
public class MySlideDeleteListView extends ListView {
	private final static String TAG = "MySlideDeleteListView";
	...
	public MySlideDeleteListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public MySlideDeleteListView(Context context, AttributeSet attrs, int defStyle) {
