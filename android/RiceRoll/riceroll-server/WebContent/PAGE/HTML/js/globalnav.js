...
}}this.vml();this.decorateTabStates();
if(AC.GlobalNav.canEnhance()&&this.globalStylesheet){this.enhancedGlobalStylesheet=this.globalStylesheet.cloneNode(true);
this.enhancedGlobalStylesheet.id="globalheader-enhanced-stylesheet";this.enhancedGlobalStylesheet.href=this.globalStylesheet.href.replace("/navigation.css","/navigation.css");
...
}return AC.GlobalNav.canEnhance._canEnhance};AC.GlobalNav.prototype.vml=function(){var e,a,c,b,d;
...
}else{this.loadedTimeout=window.setTimeout(function(){a.loaded()},10)}};